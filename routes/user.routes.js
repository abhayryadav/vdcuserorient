...
router.post('/login',
    [
        body('email').isEmail().withMessage('Invalid Email'),
        body('password').isLength({min:3}).withMessage('first name must be at least of 5 characters'),
...
router.post('/updateProfileImage',
    ...
    router.post('/deleteProfileImage',
        verifyToken, 
...
router.delete('/delete',
    [
        ...
        body('authorization').custom((_, { req }) => { if (!req.headers.authorization) {
